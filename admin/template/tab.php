...
if(isset($_POST['submit'])){
    $data['post_title'] = $_POST['tab_title'];
    $data['post_content'] = $_POST['tab_content'];
    $data['post_type'] = 'tab';
        ...
        <div class="form-section">
            <form action="" method="post" class="form form-horizontal tabForm">
                <div class="form-group">
                    ...
                    <label for="Tab Title"> Tab Title  <span class="color-red hide error_msg"> <small> (Required *) </small></span> </label>
                    <div class="form-box">
                        <input type="text" class="form-control" value="<?php echo (isset($current_post->post_title)) ? $current_post->post_title : ''; ?>" placeholder="Tab Title" name="tab_title">
                    </div>
                    <label for="Position"> Position </label>
                    <div class="form-box">
                        <select name="tab_position" class="form-control" id="">
                    ...
                    <div class="form-box">
                        <textarea name="tab_content" id="" class="richText" cols="30" rows="10"> <?php echo (isset($current_post->post_content)) ? $current_post->post_content : ''; ?></textarea>
                        <!-- /# -->
                    </div>
                    <!-- /.form-box -->
                </div>
    ...
    <div class="col-md-8 col-md-offset-1">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <p>
                        <a href="<?php echo admin_url('new-post') ?>?post=tab&id=<?php echo $post->id; ?>"> <i class="fa fa-refresh"></i></a> |
                        <a  href="<?php echo admin_url('new-post') ?>?post=tab&id=<?php echo $post->id; ?>&delete=1"> <i class="fa fa-trash"></i></a> |
                    </p>
                </td>
            </tr>
            <?php endforeach; else: ?>
