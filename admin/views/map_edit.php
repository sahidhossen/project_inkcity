    ...
    <script>
		$(document).ready(function()	{
            ...
            <?php
                    ...
                    else if ($objobject_id == 3)  {  // load polygons
            ?>
                        tmp_coords = getPathFromCoordsArray(coords);
                        var getbounds = loadPolygon(tmp_coords, "<?php echo $objtitle; ?>");
                        objectsBounds.union(getbounds);
            <?php
                    }			
		...
		<div class="jumbotron">
			...
			<div class="row" id="map_form">
				<form  method="post" action="<?php echo admin_url('maps');?>?p=map_save" role="form" data-toggle="validator">
					...
					<div class="row" id="map_info">
						...
						<a href="<?php echo admin_url('maps')?>.php?p=map_view&map_id=<?php echo $map->id; ?>" class="btn btn-warning btn-sm">Cancel</a>
