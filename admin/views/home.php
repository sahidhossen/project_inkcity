...
?>
		...
		<div class="jumbotron">
			...
			<p><a href="<?php echo admin_url('maps'); ?>?p=map_create" class="btn btn-primary active" role="button">Create Map</a> <a href="index.php?p=maps" class="btn btn-primary active" role="button">Browse Maps</a></p>
		</div>
